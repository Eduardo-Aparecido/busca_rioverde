...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 h-full bg-black/95 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
      ...
      {...props}
    >
      <div className="fixed inset-0 h-full w-full bg-black/95">
        <div className="relative h-full w-full overflow-y-auto px-6 py-6 text-foreground">
          {children}
        </div>
      </div>
